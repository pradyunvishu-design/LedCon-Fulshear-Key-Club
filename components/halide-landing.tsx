  ...
  return (
    <>
      <style>{`
        ...
        /* Middle layer: High contrast landscape */
        .layer-2 { 
        ...
        /* Top Layer: KEY CLUB LOGO */
        .layer-3 { 
          background-image: url('/screen.png'); 
          background-size: contain;
          background-repeat: no-repeat;
          background-position: center;
          filter: drop-shadow(0px 10px 30px rgba(0, 82, 204, 0.6));
          border: none;
        }
      ...
      <div className="halide-body">
        ...
        <div className="interface-grid">
          <div style={{ fontWeight: 700, letterSpacing: '2px', color: '#eaeaea' }}>KEY_CLUB_CORE</div>
          <div style={{ textAlign: 'right', fontFamily: 'monospace', color: 'var(--accent-blue)', fontSize: '0.8rem' }}>
            <div>LATITUDE: 34.0522° N</div>
            <div>FOCAL DEPTH: 80MM</div>
          </div>

          <h1 className="hero-title">LEADERSHIP<br />THROUGH<br />SERVICE</h1>

          <div style={{ gridColumn: '1 / -1', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
            <div style={{ fontFamily: 'monospace', fontSize: '0.85rem', color: '#999' }}>
              <p>[ ARCHIVE 2026 ]</p>
              <p>BUILDING CHARACTER, DEVELOPING LEADERSHIP</p>
            </div>
            <a href="#" className="cta-button" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              EXPLORE DEPTH <ChevronDown size={18} />
            </a>
          </div>
        </div>
