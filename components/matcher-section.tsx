...
export default function MatcherSection() {
  return (
    <section id="matcher" className="pt-24 pb-16" style={{ position: "relative", overflow: "hidden" }}>
      <style>{`
        .matcher-hero {
          text-align: center;
          margin-bottom: 3rem;
      ...
      <div className="section-wrapper fade-in" style={{ position: "relative", zIndex: 2 }}>
        <div className="matcher-hero">
          ...
          <h2 className="matcher-title">Find Your Perfect <br/><span className="highlight">Service Match.</span></h2>
        ...
        <div className="quiz-shell">
          ...
          <div className="quiz-step">
            <h3 className="quiz-q">What causes are you passionate about?</h3>
